...
#
set label 1001 '(a)' at screen 0.11,(t - 0.01) left font 'Times,30pt' front
#set label 1002 'Brazil' at screen 0.252,t+0.02 left font 'Times,28pt' front
set trange [0:50]
if(i==2){
set ytics 4
set xtics add ('' 744, '' 595, '' 672)
plot arquivo[1] u 1 w lines lw 3 lt rgb 'purple' title 'Real', arquivo[1] u 2 w lines lw 3 lt rgb 'red' title 'Pred.'
  }
  if(i==1){
  unset label 1001
  set xtics add ('2022-12' 744, '2010-07' 595, '2016-12' 672)
  plot arquivo[1] u 3 w lines lw 3 lt rgb 'black' notitle 'Erro'
  }
}
### FECHAMENTO
unset multiplot
