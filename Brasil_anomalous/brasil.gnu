...
#
set label 1001 '(f)' at screen 0.11,(t - 0.01) left font 'Times,30pt' front
...
set xtics add ('' 744, '' 595, '' 672)
  plot arquivo[1] u 2 w lines lw 3 lt rgb 'black' title 'Real', arquivo[1] u 3 w lines lw 3 lt rgb 'red' title 'Pred.'
  }
  if(i==1){
  unset label 1001
