...
#
set label 1001 '(d)' at screen 0.11,(t - 0.01) left font 'Times,30pt' front
#set label 1002 'Brazil' at screen 0.252,t+0.02 left font 'Times,28pt' front
set trange [0:50]
if(i==2){
set ytics 1
set xtics add ('' 744, '' 595, '' 672)
plot arquivo[1] u 2 w lines lw 3 lt rgb 'green' title 'Real', arquivo[1] u 3 w lines lw 3 lt rgb 'red' title 'Pred.'
  }
  if(i==1){
  unset label 1001
