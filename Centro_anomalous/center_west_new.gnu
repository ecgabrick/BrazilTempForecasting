...
array arquivo[2]
arquivo[1] =  "centro_oeste_treino1.dat"
arquivo[1] =  "centro_oeste_treino1.dat"
#
nomePlot = "'>>' '<<'"
#
...
#
set label 1001 '(c)' at screen 0.11,(t - 0.01) left font 'Times,30pt' front
...
plot arquivo[1] u 2 w lines lw 3 lt rgb 'orange' title 'Real', arquivo[1] u 3 w lines lw 3 lt rgb 'red' title 'Pred.'
  }
  if(i==1){
  unset label 1001
