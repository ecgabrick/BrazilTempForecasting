...
array arquivo[1]
arquivo[1] =  "centro_oeste_anomalous.dat"
#
nomePlot = "'>>' '<<'"
#
rgbLinha = "'#ff2808'"
...
set label 1003 '1993-11' at screen 0.3,t-0.2 left font 'Times,24pt' front
set xtics add ('1961-01' 1, '1991-12' 372, '2022-12' 744)
set parametric
set trange [-10:10]
  plot arquivo[1] u 2 w lines lw 3 lt rgb 'orange' notitle, 394,t w lines lw 8 lt rgb 'red' dt 3 notitle 
